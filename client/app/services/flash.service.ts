...
export class FlashService {
  ...
  getTypeClass (): string {
    switch (this.m_type) {
      case FlashType.Default: return 'tdm-flash-default';
      case FlashType.OK: return 'tdm-flash-ok';
      case FlashType.Error: return 'tdm-flash-error';
      default: return 'tdm-flash-default';
    }
  }
